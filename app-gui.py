...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self, text="   Add a User  ", fg="#ffffff",
        ...
        button3 = tk.Button(self, text="Quit", fg="#263942",
                            bg="#ffffff", command=self.on_closing)
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.buttoncanc = tk.Button(self, text="Cancel", bg="#ffffff",
...
class PageThree(tk.Frame):
    ...
    def trainmodel(self):
        ...
        messagebox.showinfo(
            "SUCCESS", "The modele has been successfully trained!")
        self.controller.show_frame("PageFour")
